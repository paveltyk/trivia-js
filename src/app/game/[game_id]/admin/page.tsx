            ...
            <Table aria-label="Questions and answers">
                ...
                <Table.Body items={questions}>
                    {(item: { id: string; question: string; answer: string }) => (
                        <Table.Row id={item.id} className={item.id === game.currentQuestion?.id ? "" : "opacity-50"}>
                            <Table.Cell>
                                <div>
        ...
        <>
            <div className="container mx-auto p-4">
                ...
                <div className="flex flex-row gap-4">
                    <div className="max-w-md rounded-lg border border-secondary">
                        <div className="border-b-1 border-primary p-4 text-lg font-semibold">Join URL</div>
                        <div className="p-4">
                            <QRCode value={lobbyUrl} size="2xl" className="m-auto w-min" />
                            <a href={lobbyUrl} target="blank" className="text-brand-700">
                                {lobbyUrl}
                            </a>
                        </div>
                        <div className="border-t-1 border-primary bg-gray-50 p-4 text-secondary">
                    ...
                    <div className="max-w-md rounded-lg border border-secondary">
                        ...
                        <div className="p-4">
                            <QRCode value={screenUrl} size="2xl" className="m-auto w-min" />
